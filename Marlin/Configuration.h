...
#define STRING_CONFIG_H_AUTHOR "Daniel White" // Original author or contributor.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 27, 30, 32, 7 } // (mm) Left, Front, Right, Back insets
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 143.49
  #define XY_DIAG_BD 140.82
  #define XY_SIDE_AD 100.84
