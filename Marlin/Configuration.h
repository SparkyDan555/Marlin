...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 143.26
  #define XY_DIAG_BD 140.57
  #define XY_SIDE_AD 100.35
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              5  // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
