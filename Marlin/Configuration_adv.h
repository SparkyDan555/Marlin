...
//
  ...
  #define TEMP_BOARD_PIN   P0_23_A0  // Board temp sensor pin override.
#endif
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { { 32, 32 }, { 203,  32 }, { 203, 203 }, {32, 202 } }
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT PROBING_MARGIN-X_MIN_POS
  #define PROBING_MARGIN_RIGHT PROBING_MARGIN
  #define PROBING_MARGIN_FRONT PROBING_MARGIN-Y_MIN_POS
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   355  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
