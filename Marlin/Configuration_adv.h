...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  32, 32 }, { 193,  32 }, { 193, 203 }, {32, 203 } }
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define PRINT_PROGRESS_SHOW_DECIMALS  // Show/report progress with decimal digits, not all UIs support this
    ...
    //#define LCD_PROGRESS_BAR            // Show a progress bar on HD44780 LCDs for SD printing
      ...
      #define PROGRESS_MSG_EXPIRE  15000  // (ms) Amount of time to retain the status message (0=forever)
 ...
 */
  ...
  #define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_EXTRA_PRIME          3  // (mm) Extra priming length
    #define TOOLCHANGE_FS_PRIME_SPEED    (3*60) // (mm/min) Extra priming feedrate
